...
function createMockRootSaga() {
    ...
    return function rootSaga() {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sagas.map(function (x) { return effects_1.fork(x); }).slice()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function runSagaMock(mock) {
    ...
    return mock.mockSagaMiddleWare.run(createMockRootSaga.apply(void 0, sagas)).done;
}
...
function stopSagaMock(mock) {
    mock.mockStore.dispatch(redux_saga_1.END);
}
